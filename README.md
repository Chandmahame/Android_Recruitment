...
&#x202b; 
در صورت کلیک بر روی نوتیفیکیشن،بر اساس مقدار path، اکتیویتی Camera.java یا Home.java باز شود.(مقدار path برابر با ```camera``` یا ```home``` خواهد بود)
&#x202b; 
آیا روش پیاده سازی شده برای چک کردن هر یک ساعت یک بار سرور شما بر روی همه دستگاه ها بطور مداوم به درستی کار می کند؟ اگر مشکلی یا مشکلاتی وجود دارد راه حل برای آن پیشنهاد کرده و 
