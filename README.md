...
&#x202b;
- تصمیم درباره جزییات بیشتر پیاده سازی و راه حل به اختیار شماست، پس سعی کنید مناسب ترین پیاده سازی که فکر می کنید را داشته
&#x202b; 
باشید.پیاده سازی قابلیت های مذکور را نسبت به UI در اولویت قرار دهید.
